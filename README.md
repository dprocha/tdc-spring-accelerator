# Introduction tdc-spring-accelerator

tdc-spring-accelerator provides you an out-of-the-box application setup to implement your business logic. It is based on the
